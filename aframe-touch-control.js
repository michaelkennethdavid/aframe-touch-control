...
AFRAME.registerComponent('touch-look-controls', {
  ...
  */
  ...
  /**
   * Translate touch move to X-axix, Y-axis rotation.
   * https://stackoverflow.com/a/48715616
   */
  onTouchMove: function (evt) {
    ...
    directionX = this.data.reverseTouchDrag ? 1 : -1;
    directionY = this.data.reverseTouchDrag ? 1 : -1;
    
    yawObject.rotation.y -= deltaY * 0.5 * directionY;
    pitchObject.rotation.x -= deltaX * 0.5 * directionX;
    pitchObject.rotation.x = Math.max(-PI_2, Math.min(PI_2, pitchObject.rotation.x));
